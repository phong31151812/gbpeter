...
def get_ids_for_service(credentials,stt=0):
    ...
    """
    global _DEVICE_ID_FILE
    name=str(stt)+'_device_id.json'
    _DEVICE_ID_FILE = os.path.join(aiy.assistant.auth_helpers._VR_CACHE_DIR, name)
